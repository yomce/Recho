  ...
  return (
    <PostLayout>
      <div className="p-4 space-y-4">
        {isLoading ? (
          <p className="text-center text-brand-gray p-8">
            게시글을 불러오는 중...
          </p>
        ) : error ? (
          ...
          posts.map((post) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-3">
                <img
                  src={
                    ...
                    `https://i.pravatar.cc/50?u=${post.user.username}`
                  }
              ...
              <div className="space-y-2">
                <h3 className="text-subheadline text-brand-text-primary">
                  {post.title}
                </h3>
                <p className="text-body text-brand-text-secondary line-clamp-3">
                  {post.content}
                </p>
              </div>
              <div className="flex items-center gap-6 mt-4 pt-3 border-t border-brand-frame">
                <div className="flex items-center gap-1.5 text-caption">
                  ...
                  <span
                    className={
                      post.userLiked ? "text-red-500" : "text-brand-gray"
                    }
                  >
                    {post.likeCount}
                  </span>
