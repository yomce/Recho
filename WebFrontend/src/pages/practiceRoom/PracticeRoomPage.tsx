...
import { type PracticeRoom, type PaginatedPracticeRoomResponse } from "@/types/practiceRoom";
    ...
    <div className="app-container">
      <div className="centered-card-container">
        <div className="w-full max-w-6xl mx-auto px-4 py-8">
          ...
          {error && (
            <div className="button-brand-gray mb-4"><p className="text-brand-error-text">{error}</p></div>
          )}
            ...
            <div className="item-list">
              {post.map((post) => (
                <div key={`${post.postId}-${post.createdAt}`} className="flex">
                  <a href={`/practice-room/${post.postId}`} className="item-card w-full">
                    ...
                    <div className="item-info flex flex-col gap-2">
                      <h3 className="text-subheadline mb-1 truncate">{post.title}</h3>
